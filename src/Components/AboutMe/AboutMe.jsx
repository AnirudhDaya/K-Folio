          ...
          <div className="detailsScroll-track">
            <div className="detail whoAmI">
              ...
              <p className="aboutmePara whoPara"> 
                ...
                my knowledge in the field. I amogus sussous specialize in creating efficient and scalable 
                solutions for complex problems. Above all, I believe in learning and building in public 
